...
// defina o pino de ligação do sensor de luminosidade
int pino_luz = A0;               
...
// declare a variável global contendo o estado do sensor de luminosidade 
int valor_luz = 0;  
...
void loop()
{
  ...
  float  temperatura = sensor_temp.getTempCByIndex(0); 
   ...
   // capture o valor do sensor de luz no pino A0 e envie para a variavel valorLuz
   valor_luz = analogRead(pino_luz);
